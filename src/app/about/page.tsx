...
export const metadata: Metadata = {
  ...
  description:
    "9+ years building scalable systems. Technical Lead, full-stack engineer, and the mind behind ThePufferLabs.",
};
...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-navy relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative border-b border-white/5 bg-navy/80 backdrop-blur-xl">
      ...
      {/* Hero */}
      <section className="relative max-w-6xl mx-auto px-6 lg:px-8 pt-16 pb-12">
        <div className="grid lg:grid-cols-[1fr_auto] gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-text-muted leading-relaxed max-w-xl mb-6">
              Associate Staff Engineer &amp; Architect at BD, building
              MedTech products at scale. 9+ years designing distributed
              systems, platform architectures, and engineering culture.
              Based in Bengaluru, India.
            </p>

            <p className="text-sm text-text-muted leading-relaxed max-w-xl mb-8">
              Expert in distributed system design, .NET, React, Kubernetes,
              KEDA, Cypress, TypeScript, and C#. From micro frontends to
              event-driven backends — I think in systems, not just syntax.
              Passionate about mentoring teams and building software that
              lasts.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 text-sm rounded-xl border border-white/10 text-text-muted hover:text-text-primary hover:border-white/20 transition-all"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 text-sm rounded-xl border border-white/10 text-text-muted hover:text-[#0A66C2] hover:border-[#0A66C2]/30 transition-all"
              >
          ...
          <div className="hidden lg:flex flex-col items-center gap-4">
            <div className="relative">
              ...
              <Image
                ...
                width={200}
                height={200}
                className="relative object-contain drop-shadow-[0_0_50px_rgba(45,212,191,0.2)]"
                loading="eager"
                priority
              />
            </div>
      ...
      <section className="relative max-w-6xl mx-auto px-6 lg:px-8 py-20">
        <h2 className="text-xs font-semibold tracking-[0.2em] uppercase text-text-dim font-mono mb-2 text-center">
          Career Journey
        </h2>
      ...
      {/* Education */}
      <section className="relative max-w-6xl mx-auto px-6 lg:px-8 pb-20">
        <h2 className="text-xs font-semibold tracking-[0.2em] uppercase text-text-dim font-mono mb-8 text-center">
          Education
        </h2>
        <div className="max-w-lg mx-auto rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
      ...
      <section className="relative max-w-6xl mx-auto px-6 lg:px-8 pb-24">
        <div className="rounded-2xl border border-teal/20 bg-gradient-to-r from-teal/[0.05] to-lime/[0.03] p-10 text-center">
          ...
          <p className="text-sm text-text-muted mb-6 max-w-lg mx-auto">
            Whether you need architecture guidance, a consulting partner, or
            want to collaborate on open source — I&apos;d love to connect.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="text-center sm:text-right">
              <p className="text-xs text-text-dim font-mono">
                &copy; {new Date().getFullYear()} ThePufferLabs
              </p>
