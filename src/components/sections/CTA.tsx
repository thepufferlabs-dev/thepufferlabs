      ...
      <div className="relative mx-auto max-w-3xl px-6 lg:px-8 text-center">
        ...
        <div className="flex justify-center mb-8">
          <Image
            ...
            width={100}
            height={100}
            className="object-contain drop-shadow-[0_0_30px_rgba(45,212,191,0.3)] animate-float"
          />
        </div>

        <span className="inline-block mb-4 text-xs font-semibold tracking-[0.2em] uppercase text-teal font-mono">
          Ready?
        </span>

        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1]">
          <span className="bg-gradient-to-r from-teal via-teal to-lime bg-clip-text text-transparent">
            Expand Your Knowledge
          </span>
        </h2>

        <p className="mx-auto mt-6 max-w-xl text-lg text-text-muted leading-relaxed">
          Join a growing community of engineers who think deeper, build
          better, and architect systems that last.
        </p>
        ...
        <p className="mt-8 text-xs text-text-dim">
          No spam. No fluff. Just engineering depth.
        </p>
      </div>
    </section>
  );
